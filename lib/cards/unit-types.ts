...
> = {
  archers: {
    stats: { str: 1, lng: 8, def: 2, hp: 4 },
    role: 'Glass-cannon ranged',
  },
  crossbowmen: {
    stats: { str: 1, lng: 7, def: 5, hp: 4 },
    role: 'Slower-firing but better shielded ranged',
  },
  spearmen: {
    stats: { str: 4, lng: 1, def: 7, hp: 5 },
    role: 'Anti-cavalry, strong defense',
  },
  swordsmen: {
    stats: { str: 7, lng: 1, def: 4, hp: 5 },
    role: 'Balanced melee striker',
  },
  halberdiers: {
    stats: { str: 6, lng: 1, def: 8, hp: 8 },
    role: 'Tank, holds the line',
  },
  knights: {
    stats: { str: 8, lng: 1, def: 5, hp: 7 },
    role: 'Heavy melee spearhead',
  },
  lightCavalry: {
    stats: { str: 5, lng: 4, def: 2, hp: 4 },
    role: 'Flexible hybrid, fragile',
  },
  siegeEngines: {
    stats: { str: 0, lng: 10, def: 1, hp: 3 },
